...
func NewImagor(
	...
	var (
		...
		imagorAutoQueryUnescape      = fs.Bool("imagor-auto-query-unescape", false, "imagor auto apply query unescape to imagor endpoint on path error")
	...
	return imagor.New(append(
		...
		imagor.WithAutoQueryUnescape(*imagorAutoQueryUnescape),
