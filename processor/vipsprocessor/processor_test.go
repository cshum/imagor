...
func TestProcessor(t *testing.T) {
	...
	t.Run("vips operations", func(t *testing.T) {
		...
		doGoldenTests(t, resultDir, []test{
			...
			{name: "text basic", path: "fit-in/300x200/10x10/filters:fill(yellow):text(IMAGOR,15,10,sans%20bold%2024,blue,30)/gopher-front.png", arm64Golden: true},
			{name: "text top left", path: "fit-in/300x200/10x10/filters:fill(yellow):text(IMAGOR,left,top,sans%2020,red,30)/gopher-front.png", arm64Golden: true},
			{name: "text right bottom", path: "fit-in/300x200/10x10/filters:fill(yellow):text(IMAGOR,right,bottom,sans%2020,green,30)/gopher-front.png", arm64Golden: true},
			{name: "text multiline wrap", path: "fit-in/300x200/10x10/filters:fill(white):text(Hello%20World%20from%20imagor,20,20,sans%2018,black,80,120)/gopher-front.png", arm64Golden: true},
			{name: "text multiline center align", path: "fit-in/300x200/10x10/filters:fill(white):text(Hello%20World%20from%20imagor,center,40,sans%2018,red,80,120,centre)/gopher-front.png", arm64Golden: true},
			{name: "text animated", path: "fit-in/150x200/10x00:10x50/filters:fill(cyan):text(GO,center,-30,sans%20bold%2018,white,0)/dancing-banana.gif", arm64Golden: true},
			{name: "text grayscale", path: "fit-in/filters:text(imagor,-1,0,sans%2030)/2bands.png", checkTypeOnly: true},
