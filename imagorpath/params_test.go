...
func TestParseGenerate(t *testing.T) {
	tests := []struct {
		...
		{
			name: "non url image with b64 prefix, but no base64 encoding",
			uri:  "meta/trim/10x11:12x13/fit-in/-300x-200/left/top/smart/filters:some_filter()/b64:some-file.jpg",
			params: Params{
				Path:        "meta/trim/10x11:12x13/fit-in/-300x-200/left/top/smart/filters:some_filter()/b64:some-file.jpg",
				Image:       "b64:some-file.jpg",
				Base64Image: false,
				Trim:        true,
				TrimBy:      "top-left",
				CropLeft:    10,
