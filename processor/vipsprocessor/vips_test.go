...
func TestVipsProcessor(t *testing.T) {
	...
	var tests = []test{
		...
		{"crop-percent stretch top flip", "0.006120x0.008993:1x1/stretch/100x200/filters:brightness(-20):contrast(50):rgb(10,-50,30):fill(black)/gopher.png"},
		...
		{"crop-percent animated", "0.1x0.05:0.89x0.32/dancing-banana.gif"},
		{"crop filter animated", "filters:crop(30,20,100,1500)/dancing-banana.gif"},
		{"crop-percent filter animated", "filters:crop(0.1x0.05:0.89x0.32)/dancing-banana.gif"},
