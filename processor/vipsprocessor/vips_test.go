...
func TestVipsProcessor(t *testing.T) {
	...
	t.Run("vips", func(t *testing.T) {
		...
		doGoldenTests(t, resultDir, []test{
			...
			{name: "fit-in unspecified height", path: "fit-in/500x0/filters:fill(fff):format(jpg)/gopher-front.png"},
			{name: "resize unspecified height", path: "500x0/filters:fill(ffffff):format(jpg)/gopher-front.png"},
			{name: "fit-in unspecified width", path: "fit-in/0x500/filters:fill(FFF):format(jpg)/gopher-front.png"},
			{name: "resize unspecified width", path: "0x500/filters:fill(FFFFFF):format(jpg)/gopher-front.png"},
