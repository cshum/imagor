...
Imagor is a Go application that utilizes the fastest libvips functions available, highly optimized for concurrent requests. It is ready to be installed and used in any Unix environment, and ready to be containerized using Docker.
