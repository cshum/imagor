...
- `detections([color[,opacity]])` draws bounding boxes for all detected regions onto the image, for use with face detection plugins such as [imagorface](https://github.com/cshum/imagorface). No-op when no Detector is configured.
