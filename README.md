...
Imagor is a Go application that is highly optimized for concurrent requests, utilizing the fastest libvips functions available, and ready to be containerized using Docker.
