...
func TestProcessor(t *testing.T) {
	...
	t.Run("vips operations", func(t *testing.T) {
		...
		doGoldenTests(t, resultDir, []test{
			...
			{name: "image default position", path: "filters:image(/100x100/gopher-front.png)/gopher.png"},
			{name: "image center", path: "filters:image(/100x100/gopher-front.png,center,center)/gopher.png"},
			{name: "image with alpha", path: "filters:image(/100x100/gopher-front.png,center,center,50)/gopher.png"},
			{name: "image negative position", path: "filters:image(/100x100/gopher-front.png,-10,-10)/gopher.png"},
			{name: "image repeat", path: "fit-in/300x300/filters:image(/50x50/gopher-front.png,repeat,repeat)/gopher.png", arm64Golden: true},
			{name: "image nested single", path: "filters:image(/150x150/filters:image(/50x50/gopher-front.png,center,center)/gopher.png,10,10)/demo1.jpg", arm64Golden: true},
			{name: "image nested double", path: "filters:image(/200x200/filters:image(/100x100/filters:image(/50x50/gopher-front.png,center,center)/gopher.png,center,center)/demo1.jpg,center,center)/gopher.png", arm64Golden: true},
