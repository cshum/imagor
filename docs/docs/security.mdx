---
description: Secure imagor in production with URL signing, stronger HMAC settings, URL expiry, allowed sources, and SSRF protections.
keywords:
  - imagor security
  - imagor url signing
  - imagor production security
...
<Head>
  <title>imagor security | URL signing, expiry, allowed sources | imagor docs</title>
  <link rel="canonical" href="https://docs.imagor.net/security" />
  <meta
    name="keywords"
    content="imagor security, imagor url signing, imagor production security, imagor ssrf protection, imagor allowed sources"
  />
  <meta
    property="og:title"
    content="imagor security | URL signing, expiry, allowed sources"
  />
  <meta
    property="og:description"
    content="Secure imagor in production with URL signing, stronger HMAC settings, URL expiry, allowed sources, and SSRF protections."
  />
  <meta
    name="twitter:title"
    content="imagor security | URL signing, expiry, allowed sources"
...
Use the [`expire`](./filters.md#expiretimestamp) filter to give a signed URL a hard expiry time. The timestamp is unix milliseconds.
...
See [HTTP Loader](./loader-http.md) for the full configuration reference.
