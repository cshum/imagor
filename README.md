...
Imagor is a Go application that is highly optimized for concurrent requests, ready to be installed and used in any Unix environment, and ready to be containerized using Docker.
