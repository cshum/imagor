...
Usage of imagor:
  ...
  -http-loader-block-networks value
  ...
  -imagor-cache-header-ttl duration
    	imagor HTTP Cache-Control header TTL for successful image response (default 168h0m0s)
  ...
  -s3-storage-class string
    	S3 File Storage Class. Available values: REDUCED_REDUNDANCY, STANDARD_IA, ONEZONE_IA, INTELLIGENT_TIERING, GLACIER, DEEP_ARCHIVE. Default: STANDARD. (default "STANDARD")
  ...
  -version
    	imagor version
  -vips-avif-speed int
    	VIPS avif speed, the lowest is at 0 and the fastest is at 9 (Default 5). (default 5)
