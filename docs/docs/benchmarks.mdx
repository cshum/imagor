...
export const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. The benchmark setup and committed summaries are public, and the page links to the benchmark project and rerun result artifacts used for this summary.',
      },
    },
  ],
};
...
- compared runtimes:
  ...
  - imgproxy: benchmark project used `darthsim/imgproxy:latest`, corresponding to imgproxy `v4.0.3`
