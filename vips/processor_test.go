...
func TestProcessor(t *testing.T) {
	...
	t.Run("meta", func(t *testing.T) {
		...
		doGoldenTests(t, resultDir, []test{
			...
			{name: "meta strip exif keep copyright", path: "meta/filters:strip_exif()/Canon_40D.jpg"},
			{name: "meta strip exif all", path: "meta/filters:strip_exif(all)/Canon_40D.jpg"},
		}, WithDebug(true), WithLogger(zap.NewExample()))
	})
	t.Run("vips operations", func(t *testing.T) {
		...
		doGoldenTests(t, resultDir, []test{
			...
			{name: "strip exif keep copyright", path: "filters:strip_exif()/Canon_40D.jpg"},
			{name: "strip exif all", path: "filters:strip_exif(all)/Canon_40D.jpg"},
